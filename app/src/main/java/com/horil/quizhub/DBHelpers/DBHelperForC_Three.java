...
public class DBHelperForC_Three extends SQLiteOpenHelper {
    private static String DB_NAME = "category_three.sqlite";
    ...
    public DBHelperForC_Three(Context context) {
    ...
    public Cursor getData() {
        ...
        this.db = SQLiteDatabase.openDatabase(this.DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
        return this.db.rawQuery("SELECT * FROM Questions WHERE ID = " + QuizActEnglish.Questionnumber, null);
    }
