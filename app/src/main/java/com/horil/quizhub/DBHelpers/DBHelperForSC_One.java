...
public class DBHelperForSC_One extends SQLiteOpenHelper {
    private static String DB_NAME = "sub_category_one.sqlite";
    public static int failed = 0;
    public String[] Answerlist = new String[]{"a", "a", "a", "a", "a", "a", "a", "a"};
    private String DB_PATH;
    private final Context context;

    public DBHelperForSC_One(Context context) {
    ...
    public Cursor getData() {
        ...
        SQLiteDatabase db = SQLiteDatabase.openDatabase(this.DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
        return db.rawQuery("SELECT * FROM Questions WHERE ID = " + QuizActIndia.Questionnumber, null);
    }
