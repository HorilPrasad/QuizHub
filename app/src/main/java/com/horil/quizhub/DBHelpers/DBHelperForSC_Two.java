...
public class DBHelperForSC_Two extends SQLiteOpenHelper {
    private static String DB_NAME = "sub_category_two.sqlite";
    ...
    public DBHelperForSC_Two(Context context) {
    ...
    public Cursor getData() {
        ...
        this.db = SQLiteDatabase.openDatabase(this.DB_PATH + DB_NAME, null, SQLiteDatabase.OPEN_READWRITE);
        return this.db.rawQuery("SELECT * FROM worldquiz WHERE ID = " + QuizActWorld.Questionnumber, null);
    }
