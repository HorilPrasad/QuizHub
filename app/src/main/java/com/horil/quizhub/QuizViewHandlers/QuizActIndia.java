...
import com.horil.quizhub.DBHelpers.DBHelperForSC_One;
...
public class QuizActIndia extends AppCompatActivity {

    //For Sqlite
    public static int Questionnumber = 0;
    public String[] data = new String[8];
    DBHelperForSC_One dbhelper;
    ...
    public static final String Wrong_Answered = "wronganswered";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SQLITE
        this.dbhelper = new DBHelperForSC_One(this);
        try {
        ...
        Intent in = getIntent();
        int clickindex = in.getIntExtra(SubCategoryOneQuiz.Click_Index, 0);
